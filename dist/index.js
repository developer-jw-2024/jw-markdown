...
__decorateClass([
  import_ts_parser_generator3.syntax.GrammarProductionFunction(`PlainText -> dollarSignTag`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__dollarSignTag", 1);
__decorateClass([
  import_ts_parser_generator3.syntax.GrammarProductionFunction(`PlainText -> doubleDollarSign`)
...
__decorateClass([
  import_ts_parser_generator3.syntax.GrammarProductionFunction(`PlainText -> PlainText dollarSignTag`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_dollarSignTag", 1);
__decorateClass([
  import_ts_parser_generator3.syntax.GrammarProductionFunction(`PlainText -> PlainText doubleDollarSign`)
