...
var Blockquote = class extends HtmlElement {
  toHtmlString(intent = "") {
    var beginTag = intent + this.buildBeginHtmlString("div", ["class", "blockquote"]);
...
var MarkdownElement = class extends syntax.SymbolEntity {
  ...
  mergeUnhandledComplementBlocks(elements) {
    var result = [].concat.apply([], elements);
    result = result.filter((x) => utils2.Utils.isTypeOf(x, ComplementBlock));
    var list = [];
    for (var i = 0; i < result.length; i++) {
  ...
  getUnhandledComplementBlockByMarkdownElement(element) {
    ...
    if (utils2.Utils.isTypeOf(element, ComplementBlock)) {
...
var Image = class extends MarkdownElement {
...
var Link = class extends MarkdownElement {
  constructor(alt, url, title = null) {
    super();
    this.alt = alt;
    this.url = url;
...
var MarkdownLanguageFunctionsEntity = class extends syntax2.LanguageFunctionsEntity {
  ...
  Image__exclamationMarkOpenSquareBracket_Sentence_closeSquareBracket_openParentheses_url_spaces_doubleQuotationMarkText_closeParentheses(argv) {
...
__decorateClass([
  syntax2.GrammarProductionFunction(`Image -> exclamationMarkOpenSquareBracket Sentence closeSquareBracket openParentheses url spaces doubleQuotationMarkText closeParentheses`)
], MarkdownLanguageFunctionsEntity.prototype, "Image__exclamationMarkOpenSquareBracket_Sentence_closeSquareBracket_openParentheses_url_spaces_doubleQuotationMarkText_closeParentheses", 1);
__decorateClass([
