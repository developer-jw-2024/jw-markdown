...
import { syntax as syntax2 } from "ts-parser-generator";

// src/MarkdownLib.ts
import { syntax, utils as utils2 } from "ts-parser-generator";
...
var DollarSignText = class extends HtmlStringElement {
  toHtmlString(intent = "") {
...
var DoubleDollarSignText = class extends HtmlStringElement {
  toHtmlString(intent = "") {
    const equation = this.value;
    const node = mathjaxDocument.convert(equation, { display: true });
    const svgOutput = adaptor.outerHTML(node);
...
// src/MarkdownLib.ts
var MarkdownElement = class extends syntax.SymbolEntity {
  constructor() {
    super(...arguments);
  ...
  mergeUnhandledBlockquotes(elements) {
    ...
    result = result.filter((x) => utils2.Utils.isTypeOf(x, Blockquote2));
    var list = [];
  ...
  mergeUnhandledComplementBlocks(elements) {
    var result = [].concat.apply([], elements);
    result = result.filter((x) => utils2.Utils.isTypeOf(x, ComplementBlock2));
    var list = [];
    for (var i = 0; i < result.length; i++) {
  ...
  getUnhandledComplementBlockByMarkdownElement(element) {
    ...
    if (utils2.Utils.isTypeOf(element, ComplementBlock2)) {
...
var MarkdownValueElement = class extends MarkdownElement {
  ...
  getRawValue() {
    if (utils2.Utils.isTypeOf(this.value, String)) {
      return this.value;
...
var Markdown = class extends MarkdownElement {
  ...
  addElement(element) {
    ...
    } else if (element.getClass() == DoubleDollarSignText2) {
      this.addDoubleDollarSignText(element);
    } else {
  ...
  addSentence(element) {
    ...
    var paragraph = null;
    if (utils2.Utils.isTypeOf(lastElement, Paragraph2)) {
  ...
  addOrderedItem(element) {
    ...
    if (utils2.Utils.isTypeOf(lastElement, OrderedList2)) {
  ...
  addUnorderedItem(element) {
    ...
    if (utils2.Utils.isTypeOf(lastElement, UnorderedList2)) {
  ...
  addBlockquoteLine(element) {
    var lastElement = this.getLastMarkdownElement();
    var blockquote = null;
    if (utils2.Utils.isTypeOf(lastElement, Blockquote2)) {
  ...
  addComplement(element) {
    var lastElement = this.getLastMarkdownElement();
    if (utils2.Utils.isNulllOrUndefinedValue(lastElement)) {
  ...
  addDashesRule(element) {
    ...
    if (utils2.Utils.isTypeOf(lastElement, Paragraph2)) {
      ...
      if (utils2.Utils.isNulllOrUndefinedValue(sentence)) {
  ...
  addTableRow(element) {
    var lastElement = this.getLastMarkdownElement();
    var table = null;
    if (utils2.Utils.isTypeOf(lastElement, Table2)) {
      table = lastElement;
    } else {
      table = new Table2();
  ...
  addDefinitionItemValue(element) {
    ...
    if (utils2.Utils.isTypeOf(lastElement, Paragraph2)) {
      ...
      if (utils2.Utils.isTypeOf(this.getLastMarkdownElement(), DefinitionList2)) {
    ...
    } else if (utils2.Utils.isTypeOf(lastElement, DefinitionList2)) {
    ...
    if (utils2.Utils.isNulllOrUndefinedValue(definitionList)) {
      throw new Error(`Can not add ${element.getClass().name} to ${this.getClass().name} with last element ${lastElement.getClass().name}`);
    } else {
  ...
  addTaskListItem(element) {
    var lastElement = this.getLastMarkdownElement();
    var taskList = null;
    if (utils2.Utils.isTypeOf(lastElement, TaskList2)) {
  ...
  addDoubleDollarSignText(element) {
    this.getMarkdownElements().push(element);
  }
  toHtml() {
    var g = new HtmlRoot();
...
var DollarSignText2 = class extends MarkdownValueElement {
  toMarkdownHierarchy(intent = "", debug = false) {
    var subIntent = `${intent}    `;
    var resultArray = this.getMarkdownElements().filter((x) => x).map((markdownElement) => {
      if (markdownElement.toMarkdownHierarchy) {
  ...
  toHtml() {
    return new DollarSignText(this.getValue());
  }
};
var DoubleDollarSignText2 = class extends MarkdownValueElement {
  toMarkdownHierarchy(intent = "", debug = false) {
    var subIntent = `${intent}    `;
    var resultArray = this.getMarkdownElements().filter((x) => x).map((markdownElement) => {
      if (markdownElement.toMarkdownHierarchy) {
  ...
  toHtml() {
    return new DoubleDollarSignText(this.getValue());
  }
};
...
// src/Language_Function.ts
var MarkdownLanguageFunctionsEntity = class extends syntax2.LanguageFunctionsEntity {
  ...
  PlainText__dollarSignTag(argv) {
    var plainText = new PlainText2();
    plainText.addChild(new DollarSignText2(argv[0].value.substring(1, argv[0].value.length - 1)));
    return plainText;
  }
  PlainText__doubleDollarSign(argv) {
    var plainText = new PlainText2();
    plainText.addChild(new DoubleDollarSignText2(argv[0].value.substring(2, argv[0].value.length - 2)));
    return plainText;
  }
  ...
  PlainText__PlainText_dollarSignTag(argv) {
    var plainText = argv[0].value;
    var dollarSignText = new DollarSignText2(argv[1].value.substring(1, argv[1].value.length - 1));
    plainText.addChild(dollarSignText);
    return plainText;
  }
  PlainText__PlainText_doubleDollarSign(argv) {
    var plainText = argv[0].value;
    var dollarSignText = new DoubleDollarSignText2(argv[1].value.substring(2, argv[1].value.length - 2));
    plainText.addChild(dollarSignText);
    return plainText;
  }
...
__decorateClass([
  syntax2.GrammarProductionFunction(
    `
...
__decorateClass([
  syntax2.GrammarProductionFunction(`MarkdownLine -> HorizontalRule`)
], MarkdownLanguageFunctionsEntity.prototype, "MarkdownLine__HorizontalRule", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BlockquoteLine -> blockquoteBiggerSignLine`)
], MarkdownLanguageFunctionsEntity.prototype, "Blockquote__blockquoteBiggerSign_MarkdownLine", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`MarkdownLine -> BlockquoteLine`)
], MarkdownLanguageFunctionsEntity.prototype, "MarkdownLine__Blockquote", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`Complement -> intent MarkdownLine`)
], MarkdownLanguageFunctionsEntity.prototype, "Complement__spaces_MarkdownLine", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`Complement -> intent`)
], MarkdownLanguageFunctionsEntity.prototype, "Complement__intent", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`MarkdownLine -> Complement`)
], MarkdownLanguageFunctionsEntity.prototype, "MarkdownLine__Complement", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`Heading -> headingSharpSign MarkdownLine`)
], MarkdownLanguageFunctionsEntity.prototype, "Heading__headingSharpSign_MarkdownLine", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`Heading -> headingSharpSign`)
], MarkdownLanguageFunctionsEntity.prototype, "Heading__headingSharpSign", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`Heading -> headingSharpSignWithCursor MarkdownLine`)
], MarkdownLanguageFunctionsEntity.prototype, "Heading__headingSharpSignWithCursor_MarkdownLine", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`Heading -> headingSharpSignWithCursor`)
], MarkdownLanguageFunctionsEntity.prototype, "Heading__headingSharpSignWithCursor", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`MarkdownLine -> Heading`)
], MarkdownLanguageFunctionsEntity.prototype, "MarkdownLine__Heading", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`OrderedItem -> orderedItemTag Sentence`)
], MarkdownLanguageFunctionsEntity.prototype, "OrderedItem__orderedItemTag_Sentence", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`OrderedItem -> orderedItemTag`)
], MarkdownLanguageFunctionsEntity.prototype, "OrderedItem__orderedItemTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`OrderedItem -> orderedItemTagWithCursor Sentence`)
], MarkdownLanguageFunctionsEntity.prototype, "OrderedItem__orderedItemTagWithCursor_Sentence", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`OrderedItem -> orderedItemTagWithCursor`)
], MarkdownLanguageFunctionsEntity.prototype, "OrderedItem__orderedItemTagWithCursor", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`MarkdownLine -> OrderedItem`)
], MarkdownLanguageFunctionsEntity.prototype, "MarkdownLine__OrderedItem", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`UnorderedItem -> unorderedItemTag Sentence`)
], MarkdownLanguageFunctionsEntity.prototype, "UnorderedItem__unorderedItemTag_Sentence", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`UnorderedItem -> unorderedItemTag`)
], MarkdownLanguageFunctionsEntity.prototype, "UnorderedItem__unorderedItemTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`UnorderedItem -> unorderedItemTagWithCursor Sentence`)
], MarkdownLanguageFunctionsEntity.prototype, "UnorderedItem__unorderedItemTagWithCursor_Sentence", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`UnorderedItem -> unorderedItemTagWithCursor`)
], MarkdownLanguageFunctionsEntity.prototype, "UnorderedItem__unorderedItemTagWithCursor", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`MarkdownLine -> UnorderedItem`)
], MarkdownLanguageFunctionsEntity.prototype, "MarkdownLine__UnorderedItem", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`Sentence -> Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "Sentence__Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`Sentence -> Sentence Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "Sentence__Sentence_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`MarkdownLine -> Sentence`)
], MarkdownLanguageFunctionsEntity.prototype, "MarkdownLine__Sentence", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> simpleText`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__simpleText", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> spaces`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__spaces", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> Link`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__Link", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> urlAddress`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__urlAddress", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> emailAddress`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__emailAddress", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> Image`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__Image", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> emoji`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__emoji", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> FootnoteReference`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__FootnoteReference", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> cursor`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__cursor", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> sharpSign`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__sharpSign", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> leftArrow`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__leftArrow", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> dashSign`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__dashSign", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> plusSign`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__plusSign", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> dollarSignTag`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__dollarSignTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> doubleDollarSign`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__doubleDollarSign", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText simpleText`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_simpleText", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText spaces`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_spaces", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText Link`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_Link", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText urlAddress`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_urlAddress", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText emailAddress`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_emailAddress", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText Image`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_Image", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText emoji`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_emoji", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText FootnoteReference`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_FootnoteReference", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText intent`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_intent", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText cursor`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_cursor", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText sharpSign`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_sharpSign", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText leftArrow`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_leftArrow", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText dashSign`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_dashSign", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText plusSign`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_plusSign", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText dollarSignTag`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_dollarSignTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`PlainText -> PlainText doubleDollarSign`)
], MarkdownLanguageFunctionsEntity.prototype, "PlainText__PlainText_doubleDollarSign", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`FootnoteReference -> openSquareBracketWithCaret simpleText closeSquareBracket`)
], MarkdownLanguageFunctionsEntity.prototype, "FootnoteReference__openSquareBracketWithCaret_simpleText_closeSquareBracket", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`Link -> openSquareBracket Sentence closeSquareBracket openParentheses url closeParentheses`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`Link -> openSquareBracket Sentence closeSquareBracket openParentheses url spaces doubleQuotationMarkText closeParentheses`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`Image -> exclamationMarkOpenSquareBracket PlainText closeSquareBracket openParentheses url spaces doubleQuotationMarkText closeParentheses`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginStarBoldText -> starBoldTag NO_StarBoldText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginStarBoldText__starBoldTag_NO_StarBoldText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginStarBoldText -> BeginStarBoldText NO_StarBoldText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginStarBoldText__BeginStarBoldText_NO_StarBoldText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`StarBoldText -> BeginStarBoldText starBoldTag`)
], MarkdownLanguageFunctionsEntity.prototype, "StarBoldText__BeginStarBoldText_starBoldTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginUnderlineBoldText -> underlineBoldTag NO_UnderlineBoldText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginUnderlineBoldText__underlineBoldTag_NO_UnderlineBoldText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginUnderlineBoldText -> BeginUnderlineBoldText NO_UnderlineBoldText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`UnderlineBoldText -> BeginUnderlineBoldText underlineBoldTag`)
], MarkdownLanguageFunctionsEntity.prototype, "UnderlineBoldText__BeginUnderlineBoldText_underlineBoldTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginStarItalicText -> starItalicTag NO_StarItalicText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginStarItalicText__starItalicTag_NO_StarItalicText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginStarItalicText -> BeginStarItalicText NO_StarItalicText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginStarItalicText__BeginStarItalicText_NO_StarItalicText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`StarItalicText -> BeginStarItalicText starItalicTag`)
], MarkdownLanguageFunctionsEntity.prototype, "StarItalicText__BeginStarItalicText_starItalicTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginUnderlineItalicText -> underlineItalicTag NO_UnderlineItalicText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginUnderlineItalicText -> BeginUnderlineItalicText NO_UnderlineItalicText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`UnderlineItalicText -> BeginUnderlineItalicText underlineItalicTag`)
], MarkdownLanguageFunctionsEntity.prototype, "UnderlineItalicText__BeginUnderlineItalicText_underlineItalicTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginStarBoldItalicText -> starBoldItalicTag NO_StarBoldItalicText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginStarBoldItalicText -> BeginStarBoldItalicText NO_StarBoldItalicText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`StarBoldItalicText -> BeginStarBoldItalicText starBoldItalicTag`)
], MarkdownLanguageFunctionsEntity.prototype, "StarBoldItalicText__BeginStarBoldItalicText_starBoldItalicTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginUnderlineBoldItalicText -> underlineBoldItalicTag NO_UnderlineBoldItalicText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginUnderlineBoldItalicText -> BeginUnderlineBoldItalicText NO_UnderlineBoldItalicText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`UnderlineBoldItalicText -> BeginUnderlineBoldItalicText underlineBoldItalicTag`)
], MarkdownLanguageFunctionsEntity.prototype, "UnderlineBoldItalicText__BeginUnderlineBoldItalicText_underlineBoldItalicTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginStrikethroughText -> strikethroughTag NO_StrikethroughText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginStrikethroughText__strikethroughTag_NO_StrikethroughText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginStrikethroughText -> BeginStrikethroughText NO_StrikethroughText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`StrikethroughText -> BeginStrikethroughText strikethroughTag`)
], MarkdownLanguageFunctionsEntity.prototype, "StrikethroughText__BeginStrikethroughText_strikethroughTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginHighlightText -> highlightTag NO_HighlightText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginHighlightText__highlightTag_NO_HighlightText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginHighlightText -> BeginHighlightText NO_HighlightText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginHighlightText__BeginHighlightText_NO_HighlightText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`HighlightText -> BeginHighlightText highlightTag`)
], MarkdownLanguageFunctionsEntity.prototype, "HighlightText__BeginHighlightText_highlightTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginSubscriptText -> subscriptTag NO_SubscriptText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginSubscriptText__subscriptTag_NO_SubscriptText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginSubscriptText -> BeginSubscriptText NO_SubscriptText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginSubscriptText__BeginSubscriptText_NO_SubscriptText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`SubscriptText -> BeginSubscriptText subscriptTag`)
], MarkdownLanguageFunctionsEntity.prototype, "SubscriptText__BeginSubscriptText_subscriptTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginSuperscriptText -> superscriptTag NO_SuperscriptText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginSuperscriptText__superscriptTag_NO_SuperscriptText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginSuperscriptText -> BeginSuperscriptText NO_SuperscriptText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginSuperscriptText__BeginSuperscriptText_NO_SuperscriptText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`SuperscriptText -> BeginSuperscriptText superscriptTag`)
], MarkdownLanguageFunctionsEntity.prototype, "SuperscriptText__BeginSuperscriptText_superscriptTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginDoubleBacktickText -> doubleBacktickTag NO_DoubleBacktickText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginDoubleBacktickText -> BeginDoubleBacktickText NO_DoubleBacktickText_Match_emphasis`)
...
__decorateClass([
  syntax2.GrammarProductionFunction(`DoubleBacktickText -> BeginDoubleBacktickText doubleBacktickTag`)
], MarkdownLanguageFunctionsEntity.prototype, "DoubleBacktickText__BeginDoubleBacktickText_doubleBacktickTag", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginBacktickText -> backtickTag NO_BacktickText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginBacktickText__backtickTag_NO_BacktickText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BeginBacktickText -> BeginBacktickText NO_BacktickText_Match_emphasis`)
], MarkdownLanguageFunctionsEntity.prototype, "BeginBacktickText__BeginBacktickText_NO_BacktickText_Match_emphasis", 1);
__decorateClass([
  syntax2.GrammarProductionFunction(`BacktickText -> BeginBacktickText backtickTag`)
