...
__decorateClass([
  import_ts_parser_generator3.syntax.GrammarProductionFunction(`Image -> exclamationMarkOpenSquareBracket Sentence closeSquareBracket openParentheses url spaces doubleQuotationMarkText closeParentheses`)
...
var MarkdownSyntaxAnalyzer = class {
  init() {
    this.lrSyntaxAnalyzerRunner = new import_ts_parser_generator4.lr.LRSyntaxAnalyzerRunner().init(languageDefinitionPath, tokenTypeDefinitionPath, MarkdownLanguageFunctionsEntity);
